...
export default function ShortenUrlForm({ apiKey, shortenedUrls, setShortenedUrls }: Props) {
  ...
  const handleSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      let shortenedUrl = await createShortenedUrl(apiKey, values.longUrl, values.shortId)
